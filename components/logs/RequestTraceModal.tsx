...
import { ArrowRight, Info, AlertTriangle, XCircle, Bug } from 'lucide-react';
          ...
          <div className="space-y-4">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-800">
                <strong>{logs.length}</strong> log entries found for this request
              </p>
            </div>
                  ...
                  return (
                    <div key={index} className="relative flex gap-4">
                      <div className="relative z-10 flex-shrink-0">
                        <div className={`p-2 rounded-full bg-white border-2 ${color.replace('text-', 'border-')}`}>
